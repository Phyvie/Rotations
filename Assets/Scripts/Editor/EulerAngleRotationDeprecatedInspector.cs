...
namespace Editor
{
    [CustomPropertyDrawer(typeof(EulerAngleRotationDeprecated))]
    public class EulerAngleRotationDeprecatedInspector : NestedPropertyDrawer<EulerAngleRotationDeprecated>
    {
        ...
        private void Initialize(SerializedProperty property)
        {
            ...
            firstGimbleRing = property.FindPropertyRelative("firstGimbleRingDeprecated");
            secondGimbleRing = property.FindPropertyRelative("secondGimbleRingDeprecated"); 
            thirdGimbleRing = property.FindPropertyRelative("thirdGimbleRingDeprecated"); 
            ...
            ((GimbleRingDeprecated)firstGimbleRing.boxedValue).parentEulerAngle = PropertyAsT; 
            ((GimbleRingDeprecated)secondGimbleRing.boxedValue).parentEulerAngle = PropertyAsT; 
            ((GimbleRingDeprecated)thirdGimbleRing.boxedValue).parentEulerAngle = PropertyAsT; 
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EulerAngleRotationDeprecated targetEulerAngle = GetPropertyAsT<EulerAngleRotationDeprecated>();
